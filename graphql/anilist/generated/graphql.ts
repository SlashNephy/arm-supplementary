...
export type ListWorksQuery = {
  Page?: {
    media?: Array<{ id: number; idMal?: number | null; title?: { native?: string | null } | null } | null> | null
    pageInfo?: { hasNextPage?: boolean | null } | null
  } | null
}

export const ListWorksDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'listWorks' },
      variableDefinitions: [
        {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'idMal' } },
                      {
                        ...
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [{ kind: 'Field', name: { kind: 'Name', value: 'native' } }],
                        },
                      },
                    ],
                  },
...
} as unknown as DocumentNode<ListWorksQuery, ListWorksQueryVariables>
